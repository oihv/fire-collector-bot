...
void Motor_Init()
{
	...
	GPIO_PinRemapConfig(GPIO_PartialRemap_TIM1, ENABLE); // TIM1 needs to be remapped
	...
	TIM_TimeBaseStructure.TIM_Period = (1000 - 1);				// Set the auto-reload register value
	...
	TIM_OCInitStructure.TIM_OCPolarity = TIM_OCPolarity_High;	  // Set high output polarity
	...
	TIM_OC1PreloadConfig(TIM1, TIM_OCPreload_Enable); // Enable TIM1 OC1 preload register
	TIM_OC2PreloadConfig(TIM1, TIM_OCPreload_Enable); // Enable TIM1 OC2 preload register
	TIM_OC3PreloadConfig(TIM1, TIM_OCPreload_Enable); // Enable TIM1 OC3 preload register
	TIM_OC4PreloadConfig(TIM1, TIM_OCPreload_Enable); // Enable TIM1 OC4 preload register
	TIM_OC1PreloadConfig(TIM3, TIM_OCPreload_Enable); // Enable TIM3 OC1 preload register
	TIM_OC2PreloadConfig(TIM3, TIM_OCPreload_Enable); // Enable TIM3 OC2 preload register
	TIM_OC3PreloadConfig(TIM3, TIM_OCPreload_Enable); // Enable TIM3 OC3 preload register
	TIM_OC4PreloadConfig(TIM3, TIM_OCPreload_Enable); // Enable TIM3 OC4 preload register
...
{
	if(position > 195) position = 195; // Ensure position is within valid range
...
void ServoMotor_Config(void)
{
    ...
    TIM_OC1PreloadConfig(TIM2, TIM_OCPreload_Enable); // Use TIM_OC1PreloadConfig for Channel 1
    TIM_OC2PreloadConfig(TIM2, TIM_OCPreload_Enable); // Use TIM_OC2PreloadConfig for Channel 2
